      ...
      <div class="parallax">
        ...
        <div class="container">
          <div class="parallax__content">
            ...
            <p class="parallax__content--text">Extensões de Alcântara em toda a cabine, enquanto os interruptores estilo caça e um enorme botão vermelho de partida.</p>
          </div>
        </div>
      </div>
      <div class="parallax">
        ...
        <div class="container">
          <div class="parallax__content">
            ...
            <p class="parallax__content--text">Abordagem voltada para a pista, usando materiais leves e de alta qualidade, principalmente fibra de carbono.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="form__wrapper">
          ...
          <form action="POST">
            ...
            <div class="mb-3">
              <input name="telefone" type="text" placeholder="* Telefone" class="form-control phone-mask" required>
            </div>
            <div class="mb-3">
